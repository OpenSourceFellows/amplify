...
router.post('/create-letter', async (req, res) => {
  ...
  try {
    ...
    const addressResponse = await Lob.addresses.create({
      name: req.body.name,
      address_line1: revisedAddress.line1,
      address_line2: revisedAddress.line2,
      address_city: revisedAddress.city,
      address_state: revisedAddress.state,
      address_zip: revisedAddress.zip,
      address_country: 'US'
    })
